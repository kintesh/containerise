...
async function handle(url, tabId) {
  ...
  let currentContainer = preferences.openInCurrentContainer;
  if (currentContainer !== null) {
    console.debug('Always open in current container--> ', currentContainer.replace(/ /g,''));
    if (currentContainer !== '') {
      const OPEN_IN_CURRENT_CONTAINER = '(' + currentContainer + ')/';
      console.debug('Non-blank always open in container --> ', OPEN_IN_CURRENT_CONTAINER);
